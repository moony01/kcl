...
현장 접수는 받지 않습니다. 온라인 사전 지원을 통과한 지원자에게만 지원서에 입력한 이메일로 정확한 오디션 시간과 장소가 안내됩니다. 스팸·정크 메일함도 함께 확인해야 합니다.

## 지원 대상

2008년생부터 2015년생까지 지원할 수 있습니다. 성별과 국적에는 제한이 없습니다.

## 모집 분야

다음 중 자신을 가장 잘 보여줄 수 있는 **한 분야만** 선택합니다.
...
YG Audition 공식 웹사이트에서 온라인 사전 지원서를 제출합니다.

- 2026 YG GLOBAL AUDITION 전체 일정에서 한 사람당 한 번만 지원할 수 있습니다.
- 제출하는 모든 사진과 영상에는 얼굴이 선명하게 보여야 합니다.
- 세부 시간과 장소는 사전 지원 통과자에게만 이메일로 전달됩니다.

일정과 접수 상태는 변경될 수 있으므로 지원 직전에 반드시 공식 페이지를 다시 확인하세요.
