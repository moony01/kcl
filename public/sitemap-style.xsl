...
<xsl:stylesheet version="2.0"
  ...
  <xsl:template match="/">
    <html lang="ko">
      <head>
        <title>KCL Sitemap - K-pop Company League</title>
      ...
      <body>
        <div class="container">
          <header>
            <h1>KCL Sitemap</h1>
            <p class="subtitle">K-pop Company League - Search Engine Optimization</p>
            <div class="stats">
              <div class="stat">
          ...
          <footer>
            <p>Generated by KCL (K-pop Company League) | <a href="https://www.kclhq.com">www.kclhq.com</a></p>
          </footer>
        </div>
      </body>
    </html>
